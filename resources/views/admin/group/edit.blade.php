                            ...
                            <form id="add-department" action="/group/{{$group->id}}" method="POST" class="add-department" novalidate="novalidate">
                                ...
                                <div class="row">
                                    <div class="form-group">
                                        ...
                                        <input name="name" type="text" class="form-control" placeholder="@lang('home.namegroup')" value="{{$group->name}}">
                                    </div>
                                    <div class="form-group">
                                      <label>@lang('home.countofsection')</label>
                                       <input name="countofsection" type="number" class="form-control" placeholder="@lang('home.countofsection')" value="{{$group->countofsection}}">
                                   </div>
                                   <div class="form-group">
